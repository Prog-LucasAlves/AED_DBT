...
class Cliente(Base):
    ...
    id_email_marketing = Column(Integer, ForeignKey("tb_email_marketing.id_email_marketing"), nullable=True)
...
class ItensPedido(Base):
    ...
    id_pedido = Column(Integer, ForeignKey("tb_pedido.id_pedido"), nullable=False)
